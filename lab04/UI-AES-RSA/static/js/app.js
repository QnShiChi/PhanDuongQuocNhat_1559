...
function renderSession() {
  sessionInfo.innerHTML = `
    ...
    <p class="mb-1"><strong>Handshake:</strong> ${state.handshakeReady ? "Đã thiết lập AES session" : "Chưa hoàn tất"}</p>
    <p class="mb-0"><strong>Thuật toán:</strong> RSA + AES-CBC</p>
  `;
...
socket.on("server_public_key", () => {
  logSecurity("Đã nhận RSA public key từ server.", "info");
  socket.emit("request_secure_session", {});
});
